...
#import psim.core.stanforddep as stanforddep
from psim.core.tree import *
...
#                 tree.buildPOSTags()
    ...
    def save(self):
        ...
        if not self.fileName.lower().endswith(".d.xml"):
            raise ValueError("Saving formats other than .d.xml unsupported")
        root=self.getETTree()
