...
import psim.cElementTreeUtils as ETUtils
import psim.core.tree_functions as TF
...
#             isComplete=False
    ...
    def editMergeToken(self,tokIdx,dir,context=u"generic"):
        ...
        if dir==u"L":
            ...
            self.tokens[tokIdx+1].text=Token.charOff2Str(self.text,self.tokens[tokIdx+1].charOff)
        self.editDelteToken(tokIdx,True,False) #True forces deletion of nonnull token here, False prevents the text to be touched
        self.buildPOSTags()
        self.hasChanged(context)
